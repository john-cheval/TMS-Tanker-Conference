...
const ConferenceProgrammeSectionTwo = ({ content }: Props) => {
  ...
  return (
    <section className="section-wrapper mt-8 pb-8 md:pb-12 lg:pb-16 ">
      <h4 className="text-center main-heading-2 md:text-left gradient-text w-fit leading-3 font-bold md:leading-[40px]  lg:leading-main ">
      ...
      <div className="space-y-6">
        ...
        {content?.map((row: any, index: number) => {
          ...
          return row?.map((innerItem: any, innerIndex: number) => {
            ...
            return (
              <div
                className={`bg-[#EFFAFF] grid grid-cols-12 gap-x-8 p-8`}
                key={innerIndex + 1}
              >
                            ...
                            (
                              ...
                              return (
                                <Image
                                  ...
                                  src={sponsorListItem?.image_url ?? "imnagw2"}
                    ...
                    <>
                        ...
                        innerItem?.moderator_list?.length > 0 && (
                          <div className="pt-2.5 space-y-2">
                            {innerItem?.moderator_list?.map(
                              (moderatorItem: any, moderatorIndex: number) => {
                                return (
                      ...
                      {innerItem?.sponsor_list?.length && (
                        <div className="pt-6 flex gap-x-6 items-center ">
                          <p className="description text-dark-alter">Sponsor</p>
                          {innerItem?.sponsor_list?.map(
                            (
                              sponsorListItem: any,
                              sponsorListIndex: number
                    ...
                    <>
                      ...
                      <div className="pt-2 session-description">
                        <p className="description text-dark-alter">
                          ...
                          knowledge within tanker shipping will reflect on their
                          approaches to implementing sustainable shipping
                          regimes. They will draw on their own experiences to
                          assess the best way to reach ambitious net
                          zero targets while maintaining optimum levels of
                          profitability and operational efficiency. Speakers
                          will discuss the key environmental challenges
                          and opportunities presented to the tanker shipping
                          business, in the context of contemporary market trends
                          in the crude, chemical and product tanker trades, as
                          well as the gas carrier segment. Topics will include:
                        </p>

                        <ul>
                          <li>
                            Setting a course to meet IMO and other environmental
                            targets in the context of uncertain tanker shipping
                            markets
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            momentum towards decarbonisation in tanker shipping
                          </li>
                        </ul>
                      </div>
                        ...
                        <div className="mt-4 md:mt-6">
                          ...
                          <div className="mt-3 space-y-4">
                            {innerItem?.speakers_list?.map(
                              (spekersItem: any, spekersItemIndex: number) => {
                                return (
                                  <div
                                    className="flex gap-x-3"
